...
| `Kimi-K3-MXFP4` | MoE | 3 (moriio wideEP only) | MI300X gfx942 2P/2D; **TP2×DP8**; needs `kimik3-wideep-disagg` image (built in-tree from `docker/vllm_disagg_inference.kimik3.ubuntu.amd.Dockerfile`) |
